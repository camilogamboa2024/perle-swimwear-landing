...
chromium --headless --disable-gpu --no-sandbox --screenshot=docs/screenshots/home_desktop.png --window-size=1440,1024 http://127.0.0.1:8001/
chromium --headless --disable-gpu --no-sandbox --screenshot=docs/screenshots/home_mobile360.png --window-size=360,800 http://127.0.0.1:8001/
chromium --headless --disable-gpu --no-sandbox --screenshot=docs/screenshots/admin-login.png --window-size=1440,1024 http://127.0.0.1:8001/admin/login/
```
